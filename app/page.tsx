      ...
      <div className="bg-white border-b shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">SAFA Trend Analiz Platformu</h1>
              <p className="text-sm text-gray-600 mt-0.5">Uçak bulgularının kapsamlı analizi ve raporlaması</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-xl font-bold text-gray-900 mb-2">Excel Dosyanızı Yükleyin</h2>
              <p className="text-sm text-gray-600">
                SAFA bulgularını içeren Excel dosyanızı yükleyin ve kapsamlı analiz raporlarına erişin
              </p>
            </div>
        ...
        <div className="mt-8 grid md:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-lg border border-gray-200 text-center">
            ...
            <div className="text-xs text-gray-600 mt-1">Kayıt İşleme Kapasitesi</div>
          </div>
          <div className="bg-white p-5 rounded-lg border border-gray-200 text-center">
            <div className="text-2xl font-bold text-green-600">15+</div>
            <div className="text-xs text-gray-600 mt-1">Farklı Görselleştirme</div>
          </div>
          <div className="bg-white p-5 rounded-lg border border-gray-200 text-center">
            <div className="text-2xl font-bold text-orange-600">100+</div>
            <div className="text-xs text-gray-600 mt-1">ATA Kodu Desteği</div>
          </div>
          <div className="bg-white p-5 rounded-lg border border-gray-200 text-center">
            <div className="text-2xl font-bold text-purple-600">⚡</div>
            <div className="text-xs text-gray-600 mt-1">Anlık Analiz</div>
          </div>
        </div>
      </div>
    </main>
