    ...
    <>
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="mb-4">
          ...
          <p className="text-xs text-gray-600 mt-0.5">System-based monthly finding density (Top 10 ATA) - Click cells to view details</p>
        </div>
        ...
        <div className="mt-4 bg-purple-50 border border-purple-200 rounded-lg p-3">
          <div className="flex items-start gap-2 mb-2">
            <span className="text-xs font-semibold text-purple-900">📊 Color Scale:</span>
      ...
      {selectedCell && (
        <DetailModal
          ...
          title={`ATA ${selectedCell.ata} - ${format(new Date(selectedCell.month + '-01'), 'MMMM yyyy', { locale: enUS })}`}
